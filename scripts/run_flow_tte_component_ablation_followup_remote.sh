...
RUN_NAME="${RUN_NAME:-flowtte_component_ablation_followup_all8_20260707_v1}"
...
run_variant 0 identity_density \
...
run_variant 1 register_soft_w5 \
...
run_variant 2 clsreg_soft_w5 \
  --context-source cls_register \
  --context-mode soft_penalty \
  --context-weight 5.0 \
  --flow-condition-mode none &
pid2=$!
