...
from src.detection import run_anomaly_detection_multilayer_private
...
def parse_args():
    ...
    parser.add_argument("--model_name", type=str, default="dinov2_vitl14", help="Name of the backbone model.")
    parser.add_argument("--data_root", type=str, default="/path/to/your/mvtec_ad_2",
                        help="Path to the root directory of the dataset.")
    parser.add_argument("--results_dir", type=str, default="./results_VAND2025_superad",
            ...
            if os.path.exists(f"{results_dir}/metrics_seed={seed}.json"):
                ...
                with open(timeit_file, 'w', newline='') as file:
                    ...
                    for object_name in objects:
                        ...
                        anomaly_scores, time_memorybank, time_inference = run_anomaly_detection_multilayer_private(
                                                                                model,
                                                                                object_name,
